"""
Script to generate js/vr-slides.js containing all 18 interactive slides for VR Architecture.
"""
import os

output_path = os.path.join(os.path.dirname(__file__), "js", "vr-slides.js")
...
print(f"Successfully generated {output_path} ({len(slides_code)} bytes)")
